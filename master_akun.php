...
<head>
    ...
    <link href="dist/css/padding.css" rel="stylesheet" type="text/css">
    <link href="dist/css/padding.css" rel="stylesheet" type="text/css">
                        ...
                        <section class="hk-sec-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-10 d-flex">
                                    <h5 class="hk-sec-title mr-2">List Account
                                        <a href="master_akun_edit.php?id_akun=new" class="tambah_button btn btn-success btn-sm btn-wth-icon icon-wthot-bg btn-rounded icon-right"><span class="btn-text">Add Account</span><span class="icon-label"><i class="fa fa-angle-right"></i> </span></a>
                                    </h5>
                                    <h5 class="hk-sec-title">
                                        <a href="transaksi_jurnal_umum_view.php" class="btn btn-primary btn-sm btn-wth-icon icon-wthot-bg btn-rounded icon-right"><span class="btn-text">Create General Ledger</span><span class="icon-label"><i class="fa fa-angle-right"></i> </span></a>
                                    </h5>
                                </div>
                                <div class="col">
                                    <div class="btn-group">
                                        <div class="dropdown">
                                            <button aria-expanded="false" data-toggle="dropdown" class="btn btn-info btn-sm dropdown-toggle btn-rounded" type="button">Action <span class="caret"></span></button>
                                            <div role="menu" class="dropdown-menu">
                                                <a class="dropdown-item" href="akuntan_saldo_awal.php?set_date=<?= $tgl_1; ?>"><i class="dropdown-icon fa fa-book"></i><span>Set Initial Balance</span></a>
                                                <a class="dropdown-item" href="#"><i class="dropdown-icon fa fa-book"></i><span>Book Closing</span></a>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <table id="datable_12" class="table tb_jps_ins tb_jps_re_ins table-hover w-100 display table-sm">
                                            <thead>
                                                <tr>
                                                    <th>Account Code</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody class="accordion accordion-type-2" id="accordion_2">
                                                ...
                                                while ($row_get = mysqli_fetch_array($query_get)) {
                                                    ...
                                                    $curr = $row_get['curr_akun'];
                                                    $debit = $row_get['debit_akun'];
                                                    $kredit = $row_get['kredit_akun'];
                                                    $saldo_awal = 0;
                                                    ...
                                                    <td style="font-size:11px; text-align:right;">' . number_format($saldo_awal) . '</td>
                                                    <td>
                                                        <a href="master_akun_edit.php?id_akun=' . $row_get['m_akun_id'] . '" class="btn btn-xs btn-icon btn-warning btn-icon-style-1 "><span class="btn-icon-wrap"><i class="fa fa-pencil"></i></span></a>
                                                ...
                                                ';
                                                    if ($row_get['detail_akun'] == "Akun Header dari") {
                                                        ...
                                                        <td>
                                                            <a href="master_akun_edit.php?id_akun=' . $row_get_sub['m_akun_id'] . '" class="btn btn-xs btn-icon btn-warning btn-icon-style-1 "><span class="btn-icon-wrap"><i class="fa fa-pencil"></i></span></a>
                                                            <a href="#" class="btn btn-xs btn-icon btn-danger btn-icon-style-1 hapus_button" data-toggle="modal" data-target="#DeleteBrandModal"
