                                                            ...
                                                            <div class="row no-gutter">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <textarea name="keterangan" id="" style="height:50px;" class="form-control form-control-sm ubah_data_input_2 keterangan_' . $id_packing . '" data-id_packing="' . $id_packing . '" ' . $readonly . '>' . $keterangan . ' </textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    echo '
                                                            <tr >
                                                                ...
                                                                <td class="text-center">
                                                                    <button href="javascript:void(0);" ' . $hide . ' type="button" name="polybag_k_' . $no_id . '" class="btn btn-xs btn-danger ubah_data_barang_kurang polybag_k_' . $no_id . '" data-no_id="' . $no_id . '" data-tes="1"><i class="fa fa-minus"></i></button>
                                                                    <input type="number" style="display:inline;width:70px" name="polybag_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak polybag_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['polybag'] . '" ' . $readonly . '>
                                                                    <button href="javascript:void(0);" ' . $hide . ' type="button" name="polybag_t_' . $no_id . '" class="btn btn-xs btn-warning ubah_data_barang_tambah polybag_t_' . $no_id . '" data-no_id="' . $no_id . '" data-tes2="1"><i class="fa fa-plus"></i></button>
                                                                </td>
                                                                <td class="text-center">
                                                                    <button href="javascript:void(0);" ' . $hide . ' type="button" name="pcs_k_' . $no_id . '" class="btn btn-xs btn-danger ubah_data_barang_kurang pcs_k_' . $no_id . '" data-no_id="' . $no_id . '" data-tes="2"><i class="fa fa-minus"></i></button>
                                                                    <input type="number" style="display:inline;width:70px" name="pcs_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak pcs_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['pcs'] . '" ' . $readonly . '>
                                                                    <button href="javascript:void(0);" ' . $hide . ' type="button" name="pcs_t_' . $no_id . '" class="btn btn-xs btn-warning ubah_data_barang_tambah pcs_t_' . $no_id . '" data-no_id="' . $no_id . '" data-tes2="2"><i class="fa fa-plus"></i></button>
                                                                </td>
                                                            </tr>
                                                        ';
                                                    $ttl_polybag += $row2['polybag'];
                                                        ...
                                                        <div class="row no-gutter">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <textarea name="keterangan" id="" style="height:50px;" class="form-control form-control-sm ubah_data_input keterangan_' . $id_packing . '" data-id_packing="' . $id_packing . '" ' . $readonly . '>' . $keterangan . ' </textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                if (isset($_GET['detail'])) {
                                    ...
                                    <div class="col-sm">
                                        <div class="row">
                                            ...
                                            <button type="submit" name="simpan_oto" class="btn btn-sm btn-warning mb-2 ml-2 d-none">Simpan & Otorisasi</button>
                                        </div>
                                    </div>
                                    ';
                                }
