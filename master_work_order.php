                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="text-transform: none;">
                            <div class="form-inline">
                                <h3 class="mr-2">Master Work Order</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-15">
                                    ...
                                    <tbody>
                                        ...
                                        $ex_customer = "";
                                        if (isset($_POST['search'])) {
                                            $where_tgl = " AND a.tgl_awal BETWEEN '" . $from . "' AND '" . $to . "'";
                                            $where_tgl1 = "a.tgl_awal BETWEEN '" . $from . "' AND '" . $to . "'";
                                        ...
                                        $menu;
                                        $status_menu;
                                        $q_menu = mysqli_query($conn, "SELECT * FROM m_akses_2 WHERE id_user = '$id_user' ");
                                        while ($row_q_menu = mysqli_fetch_assoc($q_menu)) {
                                            $menu[] = $row_q_menu['id_menu'];
                                            $status_menu[] = $row_q_menu['status'];
                                        }
                                        // var_dump($status_menu);

                                        // $sql = mysqli_query($conn, "SELECT a.* FROM tb_work_order a WHERE a.id_transaksi LIKE '%WO%' " . $where_tgl . " GROUP BY a.id_transaksi ORDER BY id_transaksi DESC");
                                        if (isset($_POST['tgl_from']) && !empty($_POST['tgl_from']) && isset($_POST['tgl_to']) && !empty($_POST['tgl_to']) && isset($_POST['searchId']) && !empty($_POST['searchId'])) {
                                            ...
                                            $sql = mysqli_query($conn, "SELECT a.* FROM tb_work_order a WHERE a.id_transaksi LIKE '$sId' " . $where_tgl . " GROUP BY a.id_transaksi ORDER BY id_transaksi DESC ");
                                        } elseif (isset($_POST['searchId']) && !empty($_POST['searchId'])) {
                                            // Jika searchId tidak kosong, tampilkan berdasarkan id_transaksi
                                            $sql = mysqli_query($conn, "SELECT a.* FROM tb_work_order a WHERE a.id_transaksi LIKE '$sId%'  GROUP BY a.id_transaksi ORDER BY id_transaksi DESC");
                                            ...
                                            $sql = mysqli_query($conn, "SELECT a.* FROM tb_work_order a WHERE " . $where_tgl1 . " GROUP BY a.id_transaksi ORDER BY id_transaksi DESC");
                                        } else {
                                            // Kondisi default jika tidak ada yang sesuai
                                            $sql = mysqli_query($conn, "SELECT a.* FROM tb_work_order a GROUP BY a.id_transaksi ORDER BY id_transaksi DESC");
                                        ...
                                        while ($row = mysqli_fetch_array($sql)) {
                                            ...
                                            if ($row['status'] == "d") {
                                                ...
                                                $ubah = '<a href="master_work_order_edit.php?id_transaksi=' . $row['id_transaksi'] . '" class="btn btn-sm btn-success">
                                              <i class="fa fa-edit"></i> Ubah</a>';
                                            } else {
                                                $status = "<p class='text-success'>Close</p>";
                                                $ubah = '<a href="master_work_order_edit.php?id_transaksi=' . $row['id_transaksi'] . '&detail=view" class="btn btn-sm btn-primary">
                                              <i class="fa fa-edit"></i> Lihat</a>';
                                              if ($_SESSION['group'] == "manajer" || $_SESSION['group'] == "owner") {
                                                  $ubah_admin = '<a href="master_work_order_edit.php?id_transaksi=' . $row['id_transaksi'] . '" class="btn btn-sm btn-success">
                                                  <i class="fa fa-edit"></i> Ubah</a>';
                                              }
                                            }

                                            if ($menu[0] == "1" && $status_menu[0] == 1) {
                                                if ($row['sts_inspek'] == '') {
                                                    $sks_inspek = "";
                                                    ...
                                                    if ($_SESSION['group'] == "manajer" || $_SESSION['group'] == "owner") {
                                                        $sks_inspek = "<a href='master_inspek_edit.php?id_transaksi=" . $row['id_transaksi'] . "' style='color:green;'>Done</a>";
                                                    }
                                                }
                                            } else {
                                                if ($row['sts_inspek'] == '') {
                                                    ...
                                                    $sks_inspek = "<a href='#' style='color:red;'>Draft</a>";
                                                } else {
                                                    $sks_inspek = "<a href='#' style='color:green;'>Done</a>";
                                                    if ($_SESSION['group'] == "manajer" || $_SESSION['group'] == "owner") {
                                            ...
                                            if ($menu[1] == "2" && $status_menu[1] == 1) {
                                                if ($row['sts_marker'] == '') {
                                                    ...
                                                    if ($_SESSION['group'] == "manajer" || $_SESSION['group'] == "owner") {
                                                        $sks_marker = "<a href='master_marker_edit.php?id_transaksi=" . $row['id_transaksi'] . "' style='color:green;'>Done</a>";
                                                    }
                                                }
                                            } else {
                                                if ($row['sts_marker'] == '') {
                                                    ...
                                                    $sks_marker = "<a href='#' style='color:red;'>Draft</a>";
                                                } else {
                                                    $sks_marker = "<a href='#' style='color:green;'>Done</a>";
                                                }
                                            }


                                            if ($menu[2] == "3" && $status_menu[2] == 1) {
                                                if ($row['sts_cutting'] == '') {
                                                    $sks_cutting = "";
                                                    ...
                                                    if ($_SESSION['group'] == "manajer" || $_SESSION['group'] == "owner") {
                                                        $sks_cutting = "<a href='master_cutting_edit.php?id_transaksi=" . $row['id_transaksi'] . "' style='color:green;'>Done</a>";
                                                    }
                                                }
                                            } else {
                                                if ($row['sts_cutting'] == '') {
                                                    ...
                                                    $sks_cutting = "<a href='#' style='color:red;'>Draft</a>";
                                                } else {
                                                    $sks_cutting = "<a href='#' style='color:green;'>Done</a>";
                                                }
                                            }


                                            if ($menu[3] == "4" && $status_menu[3] == 1) {
                                                if ($row['sts_sewing'] == '') {
                                                    $sks_sewing = "";
                                                    ...
                                                    if ($_SESSION['group'] == "manajer" || $_SESSION['group'] == "owner") {
                                                        $sks_sewing = "<a href='master_sewing_edit.php?id_transaksi=" . $row['id_transaksi'] . "' style='color:green;'>Done</a>";
                                                    }
                                                }
                                            } else {
                                                if ($row['sts_sewing'] == '') {
                                                    ...
                                                    $sks_sewing = "<a href='#' style='color:red;'>Draft</a>";
                                                } else {
                                                    $sks_sewing = "<a href='#' style='color:green;'>Done</a>";
                                                }
                                            }


                                            if ($menu[4] == "5" && $status_menu[4] == 1) {
                                                if ($row['sts_finish'] == '') {
                                                    $sks_finish = "";
                                                    ...
                                                    if ($_SESSION['group'] == "manajer" || $_SESSION['group'] == "owner") {
                                                        $sks_finish = "<a href='master_finishing_edit.php?id_transaksi=" . $row['id_transaksi'] . "' style='color:green;'>Done</a>";
                                                    }
                                                }
                                            } else {
                                                if ($row['sts_finish'] == '') {
                                                    ...
                                                    $sks_finish = "<a href='#' style='color:red;'>Draft</a>";
                                                } else {
                                                    $sks_finish = "<a href='#' style='color:green;'>Done</a>";
                                                }
                                            }


                                            if ($menu[5] == "6" && $status_menu[5] == 1) {
                                                if ($row['sts_packing'] == '') {
                                                    $sks_packing = "";
                                                ...
                                                if ($row['sts_packing'] == '') {
                                                    ...
                                                    $sks_packing = "<a href='#' style='color:red;'>Draft</a>";
                                                }
                                                else {
                                                    $sks_packing = "<a href='#' style='color:green;'>Done</a>";
                                                }
                                            }
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    <td class="fs-11" style="vertical-align:top;">' . $sks_inspek . '</td>
                                                    <td class="fs-11" style="vertical-align:top;">' . $sks_marker . '</td>
                                                    <td class="fs-11" style="vertical-align:top;">' . $sks_cutting . '</td>
                                                    <td class="fs-11" style="vertical-align:top;">' . $sks_sewing . '</td>
                                                    <td class="fs-11" style="vertical-align:top;">' . $sks_finish . '</td>
                                                    <td class="fs-11" style="vertical-align:top;">' . $sks_packing . '</td>
