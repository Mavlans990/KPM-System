...
if (isset($_POST['save'])) {
    $valid = 1;
    if ($_POST['id'] == "") {
        $insert = "INSERT INTO tb_cabang(nama_cabang,nomor_telepon,latitude,longitude) VALUES('" . mysqli_real_escape_string($conn, $_POST['nama_cabang']) . "','" . mysqli_real_escape_string($conn, $_POST['nomor_telepon']) . "','" . mysqli_real_escape_string($conn, $_POST['latitude']) . "','" . mysqli_real_escape_string($conn, $_POST['longitude']) . "')";
        ...
        $update = "UPDATE tb_cabang SET nama_cabang = '" . mysqli_real_escape_string($conn, $_POST['nama_cabang']) . "',nomor_telepon='" . mysqli_real_escape_string($conn, $_POST['nomor_telepon']) . "',longitude='" . mysqli_real_escape_string($conn, $_POST['longitude']) . "',latitude='" . mysqli_real_escape_string($conn, $_POST['latitude']) . "' WHERE id_cabang = '" . mysqli_real_escape_string($conn, $_POST['id']) . "'";
             ...
             <div class="hk-pg-wrapper">
               ...
               <?php //include "part/topbar.php"; ?>
                ...
                <div class="container-fluid mt-xl-15 mt-sm-30 mt-5">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Master Cabang</h1>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_cabang" id="" class="form-control nama_cabang" required>
                        </div>
                        <div class="form-group">
                            <label>Nomor Telepon (Gunakan awalan 62 tanpa +)</label>
                            <input type="number" name="nomor_telepon" id="" class="form-control nomor_telepon" required>
                        </div>
                        <div class="form-group">
                            <label>Latitude</label>
                            <input type="text" name="latitude" id="" class="form-control latitude" required>
                        </div>
                        <div class="form-group">
                            <label>Longitude</label>
                            <input type="text" name="longitude" id="" class="form-control longitude" required>
                        </div>
                    </div>
