                            ...
                            <div class="col-sm">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- <div class="input-group mb-3 d-none">
                                            <div class="input-group-prepend">
                                                <span style="width:150px;" class="form-control form-control-sm input-group-text" id="inputGroup-sizing-sm">Jenis Transaksi</span>
                                            </div>
                                            <select name="jenis" id="" style="height:33px;" class="form-control form-control-sm <?= $filled_input; ?> jenis" <?= $readonly; ?> autocomplete="off" onclick="this.select();">
                                                <option value="Pembelian" <?php if($jenis =='Pembelian') echo 'selected'; ?>>Pembelian</option>
                                                <option value="Mutasi Barang" <?php if($jenis =='Mutasi Barang') echo 'selected'; ?>>Mutasi Barang</option>
                                                <option value="Retur dari customer" <?php if($jenis =='Retur dari customer') echo 'selected'; ?>>Retur dari customer</option>
                                            </select>
                                        </div> -->
                                    </div>
                                ...
                                <div class="row no-gutter">
                                    ...
                                    <div class="col-md-6 mt-15">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <!-- <button type="submit" class="btn btn-sm btn-warning ml-5 " name="add_all" <?= $hide; ?>>Add All</button> -->
                                        </div>

                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend text-center">
                                                <span style="width:150px;" class="form-control form-control-sm input-group-text text-center" id="inputGroup-sizing-sm">Yard</span>
                                            </div>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input name="" id="" class="form-control form-control-sm filled-input uom_barang" value="YARD" readonly>
                                            <button type="button" class="btn btn-sm btn-success ml-5 add_list" <?php echo $hide; ?>><i class="fa fa-plus"></i></button>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-1">
                                        ...
                                        <tbody class="daftar_bahan">
                                            ...
                                            $t_qty = 0;
                                            $total = 0;
                                            $select_barang_masuk = "SELECT a.*,b.id_bahan_baku,b.nama_bahan FROM tb_barang_masuk a JOIN tb_bahan_baku b ON b.id_bahan_baku = a.id_product WHERE a.id_transaksi = '" . $id_transaksi . "'";
                                            $query_barang_masuk = mysqli_query($conn, $select_barang_masuk);
                                            $jum_barang_masuk = mysqli_num_rows($query_barang_masuk);
                                            while ($row_barang_masuk = mysqli_fetch_array($query_barang_masuk)) {
                                                $total = $total + $row_barang_masuk['total'];
                                                $qty = $row_barang_masuk['qty'];
                                                $int_qty = intval($qty);
                                                $berat = $row_barang_masuk['berat'];
                                                $k_yard = $qty * $berat;
                                                $t_yard += $k_yard; 
                                                $t_qty += $qty;
                                                echo '
                                                <tr>
                                                    <td class="text-center">' . $row_barang_masuk['id_bahan_baku'] . '</td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("click", ".add_list", function() {
            ...
            if (nama_barang.indexOf("|") >= 0 && (qty_barang !== "" && qty_barang > 0) ) {
                $.ajax({
                    type: "POST",
                    url: "ajax/ajax_barang_masuk.php",
                    data: {
