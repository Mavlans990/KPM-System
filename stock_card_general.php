                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-1" style="text-transform: none;">
                            <div class="form-group mt-5">
                                <h1 class="h3 mb-2 text-gray-800">Stock Card General</h1>
                            </div>
                            <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group form-inline">
                                                ...
                                                <a href="print/print_stock_card.php?nama_barang=<?= $nama_barang; ?>" class="btn btn-success text-white form-control-sm ml-1 mt--5" target="_blank"><i class="fa fa-print"></i> Print</a>
                                                <a href="print/print_excel_stock_card.php?nama_barang=<?= $nama_barang; ?>" target="_blank" class="btn btn-warning text-white form-control-sm ml-1 mt--5"><i class="fa fa-list"></i> Download Excel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <table class="table table-bordered table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-15">
                                    <thead>
                                        <tr class="bg-success">
                                            ...
                                            <th class="text-center text-white">Total QTY ROLL</th>
                                            <th class="text-center text-white">Total YARD</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        if (isset($_POST['search'])) {
                                            if ($nama_barang !== "") {
                                                $where_barang = " WHERE id_bahan = '" . $nama_barang . "'";
                                            }
                                        }
                                        $no = 1;
