                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="text-transform: none;">
                            <div class="form-inline">
                                <h3 class="mr-2">Laporan Sewing</h3>
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-md-6" style="display: contents;">
                                            <div class="form-group form-inline">
                                                ...
                                                <input type="text" name="line" id="" class="form-control form-control-sm line" value="<?= $line; ?>" style="margin-right: 5px;" autocomplete="off" list="list_line" onclick="this.select();">
                                                <datalist id="list_line" class="list_line">
                                                </datalist>

                                                <div class="input-group-prepend">
                                                    <span class="form-control form-control-sm input-group-text " id="inputGroup-sizing-sm">Cari PIC</span>
                                                </div>
                                                <input type="text" name="nama_pic" id="" class="form-control form-control-sm nama_pic" style="margin-right: 5px;" value="<?= $namaPic; ?>" autocomplete="off" list="list_pic" onclick="this.select();">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['search'])) {
                                            ...
                                            if ($_POST['tgl_from'] != '' && $_POST['tgl_to'] != '') {
                                                $where_tgl = " AND a.tgl_sewing BETWEEN '" . $from . "' AND '" . $to . "'";
                                            }
                                            if ($_POST['nama_pic'] != '') {
                                        ...
                                        while ($row = mysqli_fetch_array($sql)) {
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    <td class="fs-11" style="vertical-align:top;">' . $row['tgl_sewing'] . '</td>
