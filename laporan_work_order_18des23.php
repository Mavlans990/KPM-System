                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-15">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = mysqli_query($conn, "SELECT a.* FROM tb_work_order a WHERE a.id_transaksi LIKE '%WO%' " . $where_tgl . " " . $where_customer . " GROUP BY a.id_transaksi ORDER BY id_transaksi DESC LIMIT 50");
