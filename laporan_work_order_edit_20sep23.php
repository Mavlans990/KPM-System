                                ...
                                <div class="table-responsive daftar_bahan">
                                    ...
                                    while ($row = mysqli_fetch_assoc($select_barang_masuk)) {
                                        ...
                                        while ($row2 = mysqli_fetch_assoc($select_inspek)) {
                                            ...
                                            $netto = $select_terima_kain['netto'];
                                                            ...
                                                            <div class="row no-gutter">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <textarea name="keterangan" id="" style="height:50px;" class="form-control form-control-sm ubah_data_input_2 keterangan_' . $id_packing . '" data-id_packing="' . $id_packing . '" readonly required>' . $keterangan . ' </textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
