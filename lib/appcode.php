...
function generate_bahan_kain()
{
	include "koneksi.php";
	$sql = "SELECT max(id_bahan_kain) FROM tb_bahan_kain";
	$query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
	...
	if ($kode_faktur) {
		...
		//tambahkan sebanyak + 1
		$kode = $kode + 1;
		$auto_kode = "BHN-" . str_pad($kode, 4, "0",  STR_PAD_LEFT);
	} else {
		$auto_kode = "BHN-0001";
	}
	return $auto_kode;
...
function generate_bahan_material()
{
	include "koneksi.php";
	$sql = "SELECT max(kode_material) FROM tb_bahan_material";
	$query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
	...
	if ($kode_faktur) {
		...
		//tambahkan sebanyak + 1
		$kode = $kode + 1;
		$auto_kode = "MTR-" . str_pad($kode, 4, "0",  STR_PAD_LEFT);
	} else {
		$auto_kode = "MTR-0001";
	}
	return $auto_kode;
...
function generate_kategori()
{
	...
	if ($kode_faktur) {
		...
		//tambahkan sebanyak + 1
		$kode = $kode + 1;
		$auto_kode = "KTG-" . str_pad($kode, 4, "0",  STR_PAD_LEFT);
	} else {
		$auto_kode = "KTG-0001";
	}
	return $auto_kode;
...
{
	include "koneksi.php";
	$sql = "SELECT max(id_sku) FROM tb_sku";
	$query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
	...
	if ($kode_faktur) {
		...
		//tambahkan sebanyak + 1
		$kode = $kode + 1;
		$auto_kode = "SKU-" . str_pad($kode, 5, "0",  STR_PAD_LEFT);
	} else {
		$auto_kode = "SKU-00001";
	}
	return $auto_kode;
...
{
	include "koneksi.php";
	$sql = "SELECT max(id_supplier) FROM tb_supplier";
	$query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
	...
	if ($kode_faktur) {
		...
		//tambahkan sebanyak + 1
		$kode = $kode + 1;
		$auto_kode = "SUP-" . str_pad($kode, 4, "0",  STR_PAD_LEFT);
	} else {
		$auto_kode = "SUP-0001";
	}
	return $auto_kode;
...
function generate_work_order_key($prefix, $nama, $bulan, $tahun)
{
	include "koneksi.php";
	$flag = 0;
	$ambil_data = mysqli_query($conn, "select * from tb_setup where nama_setup='" . $nama . "' and ket1='" . $bulan . "' and ket2='" . $tahun . "'");
...
function generate_id_sewing($prefix, $nama, $bulan, $tahun)
{
	include "koneksi.php";
	$flag = 0;
	$ambil_data = mysqli_query($conn, "select * from tb_setup where nama_setup='" . $nama . "' and ket1='" . $bulan . "' and ket2='" . $tahun . "'");
...
function generate_id_finishing($prefix, $nama, $bulan, $tahun)
{
	include "koneksi.php";
	$flag = 0;
	$ambil_data = mysqli_query($conn, "select * from tb_setup where nama_setup='" . $nama . "' and ket1='" . $bulan . "' and ket2='" . $tahun . "'");
...
function generate_id_packing($prefix, $nama, $bulan, $tahun)
{
	include "koneksi.php";
	$flag = 0;
	$ambil_data = mysqli_query($conn, "select * from tb_setup where nama_setup='" . $nama . "' and ket1='" . $bulan . "' and ket2='" . $tahun . "'");
...
function generate_bom($prefix, $nama, $bulan, $tahun)
{
	include "koneksi.php";
	$flag = 0;
	$ambil_data = mysqli_query($conn, "select * from tb_setup where nama_setup='" . $nama . "' and ket1='" . $bulan . "' and ket2='" . $tahun . "'");
...
function generate_id_detail_bom($prefix, $nama, $bulan, $tahun)
{
	include "koneksi.php";
	$flag = 0;
	$ambil_data = mysqli_query($conn, "select * from tb_setup where nama_setup='" . $nama . "' and ket1='" . $bulan . "' and ket2='" . $tahun . "'");
...
{
	include "koneksi.php";
	$query12 = mysqli_query($conn, "SELECT max(no_id) as kodeTerbesar FROM tb_bom WHERE no_id LIKE 'BM" . date("my") . "%' ");
	$data12 = mysqli_fetch_array($query12);
	$kodeBarang12 = $data12['kodeTerbesar'];
	$urutan12 = (int) substr($kodeBarang12, 6, 6);
	$urutan12++;
...
function id_gen_work_order()
{
	include "koneksi.php";
	$query12 = mysqli_query($conn, "SELECT max(no_id) as kodeTerbesar FROM tb_work_order WHERE no_id LIKE 'IN" . date("my") . "%' ");
	$data12 = mysqli_fetch_array($query12);
	$kodeBarang12 = $data12['kodeTerbesar'];
	$urutan12 = (int) substr($kodeBarang12, 6, 6);
	$urutan12++;
...
function add_jurnal_2debit($id_jurnal, $akun_debit, $akun_debit2, $akun_kredit, $amount_debit, $amount_debit2, $amount_kredit, $tgl_bayar, $tipe_transaksi, $id_user)
{
	include "koneksi.php";
	if ($id_jurnal == "") {
		$find_date = date("ymd");
	...
	$sql_insert_debit2 = mysqli_query($conn, "
		INSERT INTO tb_jurnal_umum(
			no_transaksi,
			tgl_jurnal_umum,
			kode_akun,
	...
	if ($sql_insert_debit && $sql_insert_debit2 && $sql_insert_kredit) {
		commit();
		$valid = 1;
	} else {
		rollback();
...
function add_jurnal_3debit($id_jurnal, $akun_debit, $akun_debit2, $akun_kredit, $akun_kredit2, $amount_debit, $amount_debit2, $amount_kredit, $amount_kredit2, $tgl_bayar, $tipe_transaksi, $id_user)
{
	include "koneksi.php";
	if ($id_jurnal == "") {
		$find_date = date("ymd");
	...
	$sql_insert_kredit2 = mysqli_query($conn, "
		INSERT INTO tb_jurnal_umum(
			no_transaksi,
			tgl_jurnal_umum,
			kode_akun,
	...
	if ($sql_insert_debit && $sql_insert_debit2 && $sql_insert_kredit && $sql_insert_kredit2) {
		commit();
		$valid = 1;
	} else {
		rollback();
