...
if (isset($_POST['delete'])) {
    $valid = 1;
    $query_get_inv = mysqli_query($conn, "SELECT id_product,stock_out,id_branch FROM inv_product_out WHERE id_inv_out = '" . mysqli_real_escape_string($conn, $_POST['id_hapus']) . "' ");
    while ($row_inv = mysqli_fetch_array($query_get_inv)) {
        ...
        $query_get_product = mysqli_query($conn, "SELECT b.stock,a.type_product FROM m_branch_stock b LEFT JOIN m_product a ON b.id_product = a.m_product_id WHERE b.id_product = '" . $id_product . "' and b.id_branch = '" . $branch . "' ");
        if ($row_stock = mysqli_fetch_array($query_get_product)) {
            ...
            $query_get_product = mysqli_query($conn, "SELECT i.id_ingredients,p.stock,i.amount_ingredients FROM m_branch_stock p LEFT JOIN m_product a ON p.id_product = a.m_product_id LEFT JOIN m_ingredients i ON i.id_ingredients = p.id_product WHERE i.id_product = '" . $id_product . "' and p.id_branch = '" . $branch . "' ");
            while ($row_ingredients = mysqli_fetch_array($query_get_product)) {
                ...
                mysqli_query($conn, "UPDATE m_branch_stock SET stock = '" . $total_stock . "' WHERE id_product = '" . $id_ingredients . "' and id_branch = '" . $branch . "' ");
            }
        }
    }
    if ($valid == 1) {
        $query_del = mysqli_query($conn, "DELETE FROM inv_product_out WHERE id_inv_out ='" . mysqli_real_escape_string($conn, $_POST['id_hapus']) . "' ");
        if (!$query_del) {
            $valid = 0;
...
$add_new = 'href="inventory_product_out.php?branch=' . $get_branch . '&id_inv_out=new" ';
...
<body>
                ...
                <div class="row">
                    <div class="col">
                        <section class="hk-sec-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <h5 class="hk-sec-title">Inventory Product OUT
                                    ...
                                    <div class="table-wrap table-scroll">
                                        <table id="datable_2" class="table table-hover w-100 display">
                                            ...
                                            <tbody>
                                                ...
                                                $query_get = mysqli_query($conn, "SELECT distinct i.id_inv_out,
                                                                                    i.inv_date,
                                                                                    i.status,
                                                                                    b.nama_cabang,
                                                                                    i.id_branch
                                                ...
                                                ';
                                                    ...
                                                    <td>
                                                    ';
                                                    $query_get_product = mysqli_query($conn, "SELECT p.nm_product,p.type_product,p.uom_product,i.stock_out,i.tgl_pasang,i.id_branch,i.pemasangan,i.paket,i.stat_cus,i.part,i.keterangan,i.keterangan_part
                                                                            FROM m_product p
                                                                            JOIN inv_product_out i ON i.id_product = p.m_product_id
                                                            ...
                                                            if ($row_product['type_product'] == "Product") {
                                                                ...
                                                                if ($row_product['type_product'] == "Product") {
                                                                    if ($row_product['pemasangan'] == "pasang_sendiri") {
                                                                        $pemasangan = "<p style='font-size:11px;'>Pemasangan : Pasang Sendiri</p>";
                                                                    } else {
                                                                        $pemasangan = "<p style='font-size:11px;'>Pemasangan : " . ucfirst($row_product['pemasangan']) . "</p>";
                                                                    }
                                                                }
                                                                ...
                                                                if ($row_product['type_product'] == "Product") {
                                                                    if ($row_product['pemasangan'] == "dipasangkan") {
                                                                        if ($row_product['paket'] == "express") {
                                                                            $paket = "<p style='font-size:11px;'>Paket : Express</p>";
                                                                        } else if ($row_product['paket'] == "dirumah") {
                                                                            $paket = "<p style='font-size:11px;'>Paket : Pasang Dirumah</p>";
                                                                        } else {
                                                                            $paket = "<p style='font-size:11px;'>Paket : Regular</p>";
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if ($row_product['type_product'] == "Product") {
                                                                    if ($row_product['pemasangan'] == "dipasangkan") {
                                                                        $tanggal_pasang = "<p style='font-size:11px;'>Tanggal Pasang : " . date("d M Y", strtotime($row_product['tgl_pasang'])) . "</p>";
                                                                    }
                                                                }
                                                                ...
                                                                if ($row_product['type_product'] == "Product") {
                                                                    if ($row_product['pemasangan'] == "dipasangkan") {
                                                                        ...
                                                                        if ($row_product['paket'] !== "dirumah") {
                                                                            $cabang = "<p style='font-size:11px;'>Cabang : " . $data_cabang['nama_cabang'] . "</p>";
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if ($row_product['type_product'] == "Product") {
                                                                    if ($row_product['stat_cus'] == "yes") {
                                                                        $stat_cus = "<p style='font-size:11px;'>Body Custom : Ya</p>";
                                                                    } else {
                                                                        $stat_cus = "<p style='font-size:11px;'>Body Custom : Tidak</p>";
                                                                    }
                                                                }
                                                                ...
                                                                if ($row_product['type_product'] == "Product") {
                                                                    if ($row_product['part'] == "yes") {
                                                                        $part = "<p style='font-size:11px;'>Cat ulang / baret : Ya</p>";
                                                                    } else {
                                                                        $part = "<p style='font-size:11px;'>Cat ulang / baret : Tidak</p>";
                                                                    }
                                                                }
                                                                ...
                                                                if ($row_product['type_product'] == "Product") {
                                                                    if ($row_product['keterangan'] !== "") {
                                                                        if ($row_product['stat_cus'] == "yes") {
                                                                            $keterangan = "<p style='font-size:11px;'>Keterangan body custom : " . $row_product['keterangan'] . "</p>";
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if ($row_product['type_product'] == "Product") {
                                                                    if ($row_product['keterangan_part'] !== "") {
                                                                        if ($row_product['part'] == "yes") {
                                                                            $keterangan_part = "<p style='font-size:11px;'>Keterangan body cat ulang / baret : " . $row_product['keterangan_part'] . "</p>";
                                                                        }
                                                                    }
                                                                }

                                                                echo '
                                                                <span style="font-weight:bold;">' . $row_product['nm_product'] . ' = ' . $row_product['stock_out'] . ' ' . $row_product['uom_product'] . '</span> <br>
                                                                ';
                                                                echo $pemasangan;
                                                                echo $paket;
                                                                echo $tanggal_pasang;
                                                                ...
                                                                echo $part;
                                                                echo $keterangan;
                                                                echo $keterangan_part;
                                                            } else {
                                                                echo '
                                                                <span>' . $row_product['nm_product'] . ' = ' . $row_product['stock_out'] . ' ' . $row_product['uom_product'] . '</span> <br>
                                                            ';
                                                            }
                                                        } else {
                                                            echo '
                                                    ...
                                                    <td>
                                                        <a href="inventory_product_out.php?branch=' . $branch_id . '&id_inv_out=' . $row_get['id_inv_out'] . '&view=detail" class="mr-2 btn btn-xs btn-icon btn-info btn-icon-style-1" >
                                                            <span class="btn-icon-wrap"><i class="fa fa-eye"></i></span>
                                                        </a>
                                                        <a href="inventory_product_out.php?branch=' . $branch_id . '&id_inv_out=' . $row_get['id_inv_out'] . '" class="btn btn-xs btn-icon btn-warning btn-icon-style-1" >
                                                        ...
                                                        <a href="javascript:void(0)" class="btn btn-xs btn-icon btn-danger btn-icon-style-1 hapus_button" data-toggle="modal" data-target="#DeleteProductModal"
                                                            data-id_hapus="' . $row_get['id_inv_out'] . '" data-status="' . $row_get['status'] . '">
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", '.choose_branch', function(e) {
            ...
            window.location.replace("inventory_product_out.php?branch=" + id_branch + "&id_inv_out=new");
        });
