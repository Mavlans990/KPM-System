    ...
    <div class="hk-wrapper hk-vertical-nav">
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container-fluid mt-xl-15 mt-sm-30 mt-5">
                ...
                <div class="row">
                    <div class="col">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?id_akun=<?php echo $kode_akun_filter; ?>"
                            method="POST">
                            <section class="hk-sec-wrapper">
                                                    ...
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <select name="kat_akun" id="kategori_akun"
                                                            ...
                                                            while($row_kategori = mysqli_fetch_array($sql_get_kategori)){
                                                                echo'
                                                                    <option value="'.$row_kategori['kat_akun_id'].'" '; if($kategori == $row_kategori['kat_akun_id']){echo' selected ';} echo'>'.$row_kategori['nm_kategori'].'</option>
                                                                ';
                                                            }
                                                            echo'
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <select name="detail_akun" id="detail_akun"
                                                            ...
                                                            value="">
                                                            <option value="none" '; if($detail_akun=="none"){ echo'selected'; }  echo' >none</option>
                                                            <option value="Sub-Akun dari" '; if($detail_akun=="Sub-Akun dari"){ echo'selected'; }  echo'>Sub-Akun dari:</option>
                                                            <option value="Akun Header dari" '; if($detail_akun=="Akun Header dari"){ echo'selected'; }  echo'>Akun Header dari:</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- <div class="form-group">
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <select name="pajak_akun" id="pajak_akun"
                                                            ...
                                                            <option value="PPN" '; if($pajak == "PPN"){echo'selected';} echo'>PPN</option>
                                                        </select>
                                                    </div>
                                                </div> -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        <div class="row">
                                            <button type="submit" class="btn btn-success btn-sm" style="width:5vw;"
                                                name="finish"> Save </button>
                                            &nbsp;&nbsp;
                                            <a href="master_akun.php" class="btn btn-sm btn-danger"
                                                style="width:5vw;">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </section>
