...
if (isset($_POST['terima_bayar'])) {
    ...
    values ('" . $_POST['id_inv'] . "','" . $_POST['metode'] . "','" . $pay . "','" . $_POST['tgl_terima'] . "','" . date('Y-m-d H:i:s') . "')  ");
    $bayar = $pay;
    $hitung_ongkos = 0;
    $hitung_diskon = 0;
    $ongkos = 0;
    ...
    if ($query) {
        ...
        $jurnal_1 = add_jurnal('',  $_POST['metode'], '1-1011', $pay, $_POST['tgl_terima'], "Penerimaan Pembayaran " . $_POST['id_inv'] . "", $_SESSION['id_user']);
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control pay input_mask" name="pay" placeholder="Jumlah Diterima">
