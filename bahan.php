...
if (isset($_POST['save'])) {
    $valid = 1;
    if ($_POST['id'] == "") {
        $nama_bahan = str_replace(" ", "_", strtolower($_POST['nama_bahan']));
        $insert = "INSERT INTO tb_bahan(id,nama_bahan,filter,video,harga) VALUES('','" . mysqli_real_escape_string($conn, $_POST['nama_bahan']) . "','" . $nama_bahan . "','" . mysqli_real_escape_string($conn, $_POST['video']) . "','" . mysqli_real_escape_string($conn, $_POST['harga']) . "')";
        ...
        $nama_bahan = str_replace(" ", "_", strtolower($_POST['nama_bahan']));
        $update = "UPDATE tb_bahan SET nama_bahan = '" . mysqli_real_escape_string($conn, $_POST['nama_bahan']) . "',filter = '" . $nama_bahan . "',video = '" . mysqli_real_escape_string($conn, $_POST['video']) . "', harga = '" . mysqli_real_escape_string($conn, $_POST['harga']) . "' WHERE id = '" . mysqli_real_escape_string($conn, $_POST['id']) . "'";
...
if (isset($_POST['delete'])) {
    $valid = 1;
    $query = mysqli_query($conn, "DELETE FROM tb_bahan WHERE id='" . mysqli_real_escape_string($conn, $_POST['id_hapus']) . "'");
    if (!$query) {
        $valid = 0;
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-15" id="datable_1">
                                    ...
                                    <tbody>
                                        <?php
                                        $n = 1;
                                        $sql = mysqli_query($conn, "SELECT * FROM tb_bahan ORDER BY id ASC");
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_bahan" id="" class="form-control nama_bahan">
                                </div>
                                <div class="form-group">
                                    <label>Link Video</label>
                                    <input type="text" name="video" id="" class="form-control video">
                                </div>
                                <div class="form-group">
                                    <label>Harga</label>
                                    <input type="number" name="harga" id="" class="form-control harga" required>
                                </div>
                                <!-- <div class="form-group">
