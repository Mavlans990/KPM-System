...
if (isset($_POST['saveSew'])) {
    ...
    $id_sewing = mysqli_real_escape_string($conn, $_POST['id_sewing']);
    ...
    // Lakukan operasi UPDATE pada tabel tb_sewing untuk data utama
    $update_sewing = "UPDATE tb_sewing SET
        ...
        anggota = '" . $anggota . "',
        pic = '" . $pic . "'
        WHERE id_sewing = '" . $id_sewing . "';
    ";

    // Eksekusi query update data utama
    $query_main_update = mysqli_query($conn, $update_sewing);

    if ($query_main_update) {
        // Data utama berhasil diubah, sekarang update detail data
        $select_barang_masuk = mysqli_query($conn, "SELECT * FROM tb_sewing WHERE id_transaksi = '" . $id_transaksi . "'");

        while ($row2 = mysqli_fetch_assoc($select_barang_masuk)) {
            $no_id = $row2['no_id'];

            // Ambil data yang diubah dari form (qty_jadi, bs, turun, btj, ket)
            $qty_jadi = mysqli_real_escape_string($conn, $_POST['qty_jadi_' . $no_id]);
            $bs = mysqli_real_escape_string($conn, $_POST['bs_' . $no_id]);
            $turun = mysqli_real_escape_string($conn, $_POST['turun_' . $no_id]);
            $btj = mysqli_real_escape_string($conn, $_POST['btj_' . $no_id]);
            $ket = mysqli_real_escape_string($conn, $_POST['ket_' . $no_id]);

            // Lakukan operasi UPDATE pada tabel tb_sewing untuk detail data
            $update_detail_sewing = "UPDATE tb_sewing SET
                qty_jadi = '" . $qty_jadi . "',
                bs = '" . $bs . "',
                turun = '" . $turun . "',
                btj = '" . $btj . "',
            ...
            $query_detail_update = mysqli_query($conn, $update_detail_sewing);
        }

        if ($query_detail_update) {
    ...
    echo "<script type='text/javascript'>alert('" . $msg . "');window.location='master_sewing_edit.php?id_transaksi=$id_transaksi';</script>";
}
...
if (isset($_POST['simpan_oto'])) {
    ...
    $query_wo = mysqli_query($conn, "SELECT * FROM tb_sewing WHERE id_transaksi = '" . $id_transaksi . "'");
    ...
    if ($jum > 0) {
        ...
        <script>
            ...
            window.location.href="master_sewing_edit.php?id_transaksi=' . $id_transaksi . '";
        </script>
        ';
    }
...
if (isset($_POST['add_tabel'])) {
    ...
    $id_sewing = generate_id_sewing("SWG", "SWG", date("m"), date("y"));
    while ($row = mysqli_fetch_assoc($query_wo)) {
        $sql_update_barang_keluar = mysqli_query($conn, "INSERT INTO tb_sewing(
            id_sewing,
            id_transaksi,
            id_sku
        ) VALUES(
    ...
    header("location:master_sewing_edit.php?id_transaksi=" . $id_transaksi);
}
                                                        ...
                                                        <div class="row no-gutter">
                                                            <div class="col-12">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="hidden" name="id_sewing" value="' . $row['id_sewing'] . '">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="number" name="line" id="" class="form-control form-control-sm ubah_data_input line_' . $id_sewing . '" data-id_sewing="' . $id_sewing . '" value="' . $line . '" ' . $readonly . ' required step="0.001">
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input type="number" name="anggota" id="" class="form-control form-control-sm ubah_data_input anggota_' . $id_sewing . '" data-id_sewing="' . $id_sewing . '" value="' . $anggota . '" ' . $readonly . ' required step="0.001">
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="input-group mb-3">
                                                    ...
                                                    echo '
                                                                <tr >
                                                                    ...
                                                                    <td class="text-center">
                                                                        <button href="javascript:void(0);" ' . $hide . ' type="button" name="qty_jadi_k_' . $no_id . '" class="btn btn-xs btn-danger ubah_data_barang_kurang qty_jadi_k_' . $no_id . '" onclick="kurangiNilaiqtyJadi(' . $no_id . ')" data-no_id="' . $no_id . '" data-tes="1"><i class="fa fa-minus"></i></button>
                                                                        <input type="number" style="display:inline;width:70px" name="qty_jadi_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak myInput qty_jadi_ ' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['qty_jadi'] . '" ' . $readonly . '>
                                                                        <button href="javascript:void(0);" ' . $hide . ' type="button" name="qty_jadi_t_' . $no_id . '" class="btn btn-xs btn-warning ubah_data_barang_tambah qty_jadi_t_' . $no_id . '" onclick="tambahNilaiqtyJadi(' . $no_id . ')" data-no_id="' . $no_id . '" data-tes2="1"><i class="fa fa-plus"></i></button>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <button href="javascript:void(0);" ' . $hide . ' type="button" name="bs_k_' . $no_id . '" class="btn btn-xs btn-danger ubah_data_barang_kurang bs_k_' . $no_id . '" onclick="kurangiNilaiBs_(' . $no_id . ')" data-no_id="' . $no_id . '" data-tes="2"><i class="fa fa-minus"></i></button>
                                                                        <input type="number" style="display:inline;width:70px" name="bs_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak myInput bs_ ' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['bs'] . '" ' . $readonly . '>
                                                                        <button href="javascript:void(0);" ' . $hide . ' type="button" name="bs_t_' . $no_id . '" class="btn btn-xs btn-warning ubah_data_barang_tambah bs_t_' . $no_id . '" onclick="tambahNilaiBs_(' . $no_id . ')" data-no_id="' . $no_id . '" data-tes2="2"><i class="fa fa-plus"></i></button>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <button href="javascript:void(0);" ' . $hide . ' type="button" name="turun_k_' . $no_id . '" class="btn btn-xs btn-danger ubah_data_barang_kurang turun_k_' . $no_id . '" onclick="kurangiNilaiTurun_k_(' . $no_id . ')" data-no_id="' . $no_id . '" data-tes="3"><i class="fa fa-minus"></i></button>
                                                                        <input type="number" style="display:inline;width:70px" name="turun_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak myInput turun_ ' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['turun'] . '" ' . $readonly . '>
                                                                        <button href="javascript:void(0);" ' . $hide . ' type="button" name="turun_t_' . $no_id . '" class="btn btn-xs btn-warning ubah_data_barang_tambah turun_t_' . $no_id . '" onclick="tambahNilaiTurun_k_(' . $no_id . ')" data-no_id="' . $no_id . '" data-tes2="3"><i class="fa fa-plus"></i></button>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <button href="javascript:void(0);" ' . $hide . ' type="button" name="btj_k_' . $no_id . '" class="btn btn-xs btn-danger ubah_data_barang_kurang btj_k_' . $no_id . '" onclick="kurangiNilaiBtj_k_(' . $no_id . ')" data-no_id="' . $no_id . '" data-tes="4"><i class="fa fa-minus"></i></button>
                                                                        <input type="number" style="display:inline;width:70px" name="btj_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak myInput btj_ ' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['btj'] . '" ' . $readonly . '>
                                                                        <button href="javascript:void(0);" ' . $hide . ' type="button" name="btj_t_' . $no_id . '" class="btn btn-xs btn-warning ubah_data_barang_tambah btj_t_' . $no_id . '" onclick="tambahNilaiBtj_k_(' . $no_id . ')" data-no_id="' . $no_id . '" data-tes2="4"><i class="fa fa-plus"></i></button>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <textarea name="ket_' . $no_id . '" id="" style="height:33px;" class="form-control form-control-sm ubah_data_barang_tembak myInput ket_' . $no_id . '" data-no_id="' . $no_id . '" ' . $readonly . 'required>' . $row2['ket'] . '</textarea>
                                                                    </td>
                                                                </tr>
                                                            ';
                                        ...
                                        <div class="row mt-10 justify-content-end">
                                            <div class="col-sm-2">
                                                <div class="form-group form-group-sm">
                                                    <button type="submit" <?= $hide ?> class="btn btn-success btn-sm tbBtn" style="width:10vw;" name="add_tabel" style="color:white;"><i class="fa fa-plus"></i> Tambah Tabel</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                if (isset($_GET['detail'])) {
                                    ...
                                    <div class="col-sm">
                                        <div class="row">
                                            ...
                                            <button type="submit" name="saveSew" class="svBtn btn btn-sm btn-success ml-2 mb-2">Simpan</button>
...
function kurangiNilaiqtyJadi(no_id) {
    var input = document.querySelector('input[name="qty_jadi_' + no_id + '"]');
    if (input.value != "") {
    ...
    function tambahNilaiqtyJadi(no_id) {
        var input = document.querySelector('input[name="qty_jadi_' + no_id + '"]');
        if (input.value != "") {
            let value = parseInt(input.value);
            value += 1;
    ...
    function kurangiNilaiBs_(no_id){
    ...
    function kurangiNilaiTurun_k_(no_id) {
    ...
    function tambahNilaiTurun_k_(no_id) {
        var input = document.querySelector('input[name="turun_' + no_id + '"]');
        if (input.value != "") {
            let value = parseInt(input.value);
            value += 1;
    ...
    function kurangiNilaiBtj_k_(no_id) {
        var input = document.querySelector('input[name="btj_' + no_id + '"]');
        if (input.value != "") {
            let value = parseInt(input.value);
            if (value > 0) {
                value -= 1;
    ...
    function tambahNilaiBtj_k_(no_id) {
        var input = document.querySelector('input[name="btj_' + no_id + '"]');
        if (input.value != "") {
            let value = parseInt(input.value);
            value += 1;
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".del_list", function() {
            var id_hapus = $(this).data('id_sewing');
        ...
        //     var qty_jadi = $(".qty_jadi_" + no_id).val();
        ...
        //     var no_id = $(this).data('no_id');
        //     var id_transaksi = "<?= $id_transaksi; ?>";
        //     var qty_jadi = $(".qty_jadi_k_" + no_id).val();
        //     var bs = $(".bs_k_" + no_id).val();
        //     var turun = $(".turun_k_" + no_id).val();
        //     var btj = $(".btj_k_" + no_id).val();
        //     var ket = $(".ket_" + no_id).val();
        ...
        //     var id_sewing = $(this).data('id_sewing');
        //     var id_transaksi = "<?= $id_transaksi; ?>";
        //     var tgl_sewing = $(".tgl_sewing_" + id_sewing).val();
        //     // var uom = $(".uom_" + no_id).val();
        //     $.ajax({
        //         type: "POST",
        //         url: "ajax/ajax_sewing.php",
        //         data: {
        //             "ubah_data_input": id_sewing,
        //             "id_transaksi": id_transaksi,
        //             "tgl_sewing": tgl_sewing
        //         },
        //         cache: true,
        ...
        //     var id_sewing = $(this).data('id_sewing');
        //     var id_transaksi = "<?= $id_transaksi; ?>";
        //     var jam_mulai = $(".jam_mulai_" + id_sewing).val();
        //     // var uom = $(".uom_" + no_id).val();
        //     $.ajax({
        //         type: "POST",
        //         url: "ajax/ajax_sewing.php",
        ...
        //     var id_sewing = $(this).data('id_sewing');
        //     var id_transaksi = "<?= $id_transaksi; ?>";
        //     var jam_selesai = $(".jam_selesai_" + id_sewing).val();
        //     // var uom = $(".uom_" + no_id).val();
        //     $.ajax({
        //         type: "POST",
        //         url: "ajax/ajax_sewing.php",
        ...
        //     var id_sewing = $(this).data('id_sewing');
        //     var id_transaksi = "<?= $id_transaksi; ?>";
        //     var anggota = $(".anggota_" + id_sewing).val();
        //     // var uom = $(".uom_" + no_id).val();
        //     $.ajax({
        //         type: "POST",
        //         url: "ajax/ajax_sewing.php",
