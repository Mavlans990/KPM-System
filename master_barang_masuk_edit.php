...
if (isset($_GET['id_transaksi'])) {
    if ($_GET['id_transaksi'] !== "new") {
        ...
        $no_sj_greige = $data_barang_masuk['no_sj_greige'];
        $no_sj_celup = $data_barang_masuk['no_sj_celup'];
        $greige_by = $data_barang_masuk['greige_by'];
        $celup_by = $data_barang_masuk['celup_by'];
        $no_ph_bahan = $data_barang_masuk['no_ph_bahan'];
        $keterangan = $data_barang_masuk['keterangan'];
        $penerima = $data_barang_masuk['penerima'];
        $tgl_masuk = date("Y-m-d", strtotime($data_barang_masuk['tgl_transaksi']));
...
if (isset($_POST['simpan'])) {
    ...
    $no_sj_greige = mysqli_real_escape_string($conn, $_POST['no_sj_greige']);
    $no_sj_celup = mysqli_real_escape_string($conn, $_POST['no_sj_celup']);
    $greige_by = mysqli_real_escape_string($conn, $_POST['greige_by']);
    $celup_by = mysqli_real_escape_string($conn, $_POST['celup_by']);
    $no_ph_bahan = mysqli_real_escape_string($conn, $_POST['no_ph_bahan']);
    ...
    if ($id_transaksi == "new") {
        ...
        $update = "UPDATE tb_barang_masuk SET
            ...
            no_sj_greige = '" . $no_sj_greige . "',
            no_sj_celup = '" . $no_sj_celup . "',
            greige_by = '" . $greige_by . "',
            celup_by = '" . $celup_by . "',
            no_ph_bahan = '" . $no_ph_bahan . "',
            status = 'd',
                ...
                <div class="container-fluid mt-xl-15 mt-sm-30 mt-5">
                    ...
                    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                        <div class="card shadow mb-4">
                            <h4 class="hk-sec-title" style="margin:1rem;">Production Result</h4>
                                            ...
                                            <div class="col-12">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span style="width:150px;" class="form-control form-control-sm input-group-text " id="inputGroup-sizing-sm">NO SJ GREIGE</span>
                                                    </div>
                                                    <input type="text" name="no_sj_greige" id="" class="form-control form-control-sm no_sj_greige" value="<?= $no_sj_greige; ?>" <?= $readonly; ?>>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span style="width:150px;" class="form-control form-control-sm input-group-text " id="inputGroup-sizing-sm">NO SJ CELUP</span>
                                                    </div>
                                                    <input type="text" name="no_sj_celup" id="" class="form-control form-control-sm no_sj_celup" value="<?= $no_sj_celup; ?>" <?= $readonly; ?>>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row no-gutter">
                                            <div class="col-12">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span style="width:150px;" class="form-control form-control-sm input-group-text " id="inputGroup-sizing-sm">GREIGE BY</span>
                                                    </div>
                                                    <input type="text" name="greige_by" list="greige_list" id="" class="form-control form-control-sm greige_by" value="<?= $greige_by; ?>" <?= $readonly; ?>>
                                                    <datalist id="greige_list" class="greige_list">
                                                    </datalist>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span style="width:150px;" class="form-control form-control-sm input-group-text " id="inputGroup-sizing-sm">CELUP BY</span>
                                                    </div>
                                                    <input type="text" name="celup_by" list="celup_list" id="" class="form-control form-control-sm celup_by" value="<?= $celup_by; ?>" <?= $readonly; ?>>
                                                    <datalist id="celup_list" class="celup_list">
                                                    </datalist>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row no-gutter">
                                            <div class="col-12">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span style="width:150px;" class="form-control form-control-sm input-group-text " id="inputGroup-sizing-sm">TGL MASUK</span>
                                                    </div>
                                                    <input type="date" name="tgl_masuk" id="" class="form-control form-control-sm tgl_masuk" value="<?= $tgl_masuk; ?>" <?= $readonly; ?>>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span style="width:150px;" class="form-control form-control-sm input-group-text " id="inputGroup-sizing-sm">NO PO BAHAN</span>
                                                    </div>
                                                    <input type="text" name="no_ph_bahan" id="" class="form-control form-control-sm no_ph_bahan" value="<?= $no_ph_bahan; ?>" <?= $readonly; ?>>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mt-15">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend text-center">
                                                <span style="width:150px;" class="form-control form-control-sm input-group-text " id="inputGroup-sizing-sm">Bahan Kain</span>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="table-responsive daftar_bahan">
                                    ...
                                    $ksl_susut = 0;
                                    $ksl_shrinkage = 0;
                                    $select_barang_masuk = mysqli_query($conn, "SELECT * FROM tb_barang_masuk WHERE id_transaksi = '" . $id_transaksi . "' GROUP BY id_bahan_kain");
                                    ...
                                    while ($row = mysqli_fetch_assoc($select_barang_masuk)) {
                                        ...
                                        $sql_lot = mysqli_query($conn, "SELECT SUBSTRING(lot, 1, 5) AS lot_group FROM tb_barang_masuk WHERE id_bahan_kain = '" . $row['id_bahan_kain'] . "' AND id_transaksi = '" . $id_transaksi . "' GROUP By lot_group");
                                        while ($lot_row = mysqli_fetch_assoc($sql_lot)) {
                                            ...
                                            $select_barang_masuk_3 = mysqli_query($conn, "SELECT * FROM tb_barang_masuk WHERE id_bahan_kain = '" . $row['id_bahan_kain'] . "' AND id_transaksi = '" . $id_transaksi . "' AND lot LIKE '%" . $lot_row['lot_group'] . "%' ORDER BY CAST(SUBSTRING(lot, 5, POSITION(' | ROLL-' IN lot) - 5) AS UNSIGNED), CAST(SUBSTRING(lot, POSITION(' | ROLL-' IN lot) + 8) AS UNSIGNED); ");
                                                ...
                                                echo '
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="javascript:void(0);" ' . $hide . ' class="btn btn-xs btn-danger del_list del_list_' . $row3['no_id'] . '" data-id="' . $row3['no_id'] . '"><i class="fa fa-trash-o"></i></a>
                                        ...
                                        // <td class="text-center"><input type="text" name="lot_'.$no_id.'" class="lot_'.$no_id.'" '.$readonly.'></td>
                                        // <select name="lot_'.$no_id.'" class="lot_'.$no_id.'" style="width: 180px;">
                                        //     <option value="LOT-1">LOT-1</option>
                                        //     <option value="LOT-2">LOT-2</option>
                                        //     <option value="LOT-3">LOT-3</option>
                                        // </select>
                                        // <input type="text" name="lot_' . $no_id . '"  class="form-control form-control-sm lot lot_' . $no_id . '" autocomplete="off" list="list_lot" onclick="this.select();">
                                        //             <datalist id="list_lot" class="list_lot">
                                        //             </datalist>
                                        // <td class="text-center">LOT : <input type="number" name="lot_' . $no_id . '" class="form-control form-control-sm lot_' . $no_id . '"  ' . $readonly . '></td>
                                        //             <td class="text-center">ROLL : <input type="number" name="roll_' . $no_id . '" class="form-control form-control-sm roll_' . $no_id . '" ' . $readonly . '></td>
                                        echo '
                                                <tr ' . $hide . '>
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center"><input type="number" name="bruto_' . $no_id . '" class="form-control form-control-sm bruto_' . $no_id . '" ' . $readonly . ' step="0.001"></td>
                                                    <td class="text-center"><input type="number" name="netto_' . $no_id . '" class="form-control form-control-sm netto_' . $no_id . '" ' . $readonly . ' step="0.001"></td>
                                                    <td class="text-center"></td>
                                                    <td class="text-center"></td>
                                                    <td class="text-center">
                                                        <a href="javascript:void(0);" ' . $hide . ' class="btn btn-xs btn-success add_list_2 add_list_2_' . $no_id . '" data-id="' . $no_id . '" data-id_bahan_kain="' . $id_bahan_kain . '"><i class="fa fa-plus"></i></a>
                                                    </td>
                                                </tr>
                                            ';
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("keyup", ".greige_by", function() {
            var nama_barang = $(this).val();
            $.ajax({
                type: "POST",
                url: "ajax/ajax_barang_masuk.php",
                data: {
                    "cari_nama_supplier": nama_barang
                },
                cache: true,
                success: function(result) {
                    $(".greige_list").html(result);
                }
            });
        });
        $(document).on("keyup", ".celup_by", function() {
            var nama_barang = $(this).val();
            $.ajax({
                type: "POST",
                url: "ajax/ajax_barang_masuk.php",
        ...
        $(document).on("click", ".add_list_2", function() {
            ...
            var roll = $(".roll_" + id_tambah).val();
            var bruto = $(".bruto_" + id_tambah).val();
            var netto = $(".netto_" + id_tambah).val();
