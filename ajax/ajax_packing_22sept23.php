            ...
            while ($row2 = mysqli_fetch_assoc($select_barang_masuk_2)) {
                ...
                $hasil = $hasil . '
                            <tr >
                                <td class="text-center">' . $no++ . '</td>
                                <td class="text-center" >' . $q_sku['nama_sku'] . ' - ' . $q_sku['warna'] . ' - ' . $q_sku['ukuran'] . '</td>
                                <td class="text-center"><input type="number" style="display:inline;width:70px" name="total_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak total_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['total'] . '" step="0.001"></td>
                                <td class="text-center"><input type="number" style="display:inline;width:70px" name="bs_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak bs_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['bs'] . '" step="0.001"></td>
                                <td class="text-center"><input type="number" style="display:inline;width:70px" name="cuci_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak cuci_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['cuci'] . '" step="0.001"></td>
                                <td class="text-center"><input type="number" style="display:inline;width:70px" name="kotor_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak kotor_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['kotor'] . '" step="0.001"></td>
                                <td class="text-center"><input type="number" style="display:inline;width:70px" name="turun_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak turun_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['turun'] . '" step="0.001"></td>
                            </tr>
                        ';
            ...
            $hasil = $hasil . '
                    <tr >
                        ...
                        <td class="text-center">
                            <button href="javascript:void(0);" type="button" name="polybag_k_' . $no_id . '" class="btn btn-xs btn-danger ubah_data_barang_kurang polybag_k_' . $no_id . '" data-no_id="' . $no_id . '" data-tes="1"><i class="fa fa-minus"></i></button>
                            <input type="number" style="display:inline;width:70px" name="polybag_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak polybag_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['polybag'] . '">
                            <button href="javascript:void(0);" type="button" name="polybag_t_' . $no_id . '" class="btn btn-xs btn-warning ubah_data_barang_tambah polybag_t_' . $no_id . '" data-no_id="' . $no_id . '" data-tes2="1"><i class="fa fa-plus"></i></button>
                        </td>
                        <td class="text-center">
                            <button href="javascript:void(0);" type="button" name="pcs_k_' . $no_id . '" class="btn btn-xs btn-danger ubah_data_barang_kurang pcs_k_' . $no_id . '" data-no_id="' . $no_id . '" data-tes="2"><i class="fa fa-minus"></i></button>
                            <input type="number" style="display:inline;width:70px" name="pcs_' . $no_id . '" class="form-control form-control-sm ubah_data_barang_tembak pcs_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $row2['pcs'] . '">
                            <button href="javascript:void(0);" type="button" name="pcs_t_' . $no_id . '" class="btn btn-xs btn-warning ubah_data_barang_tambah pcs_t_' . $no_id . '" data-no_id="' . $no_id . '" data-tes2="2"><i class="fa fa-plus"></i></button>
                        </td>
                    </tr>
                ';
            $ttl_polybag += $row2['polybag'];
            ...
            <div class="col-md-5">
                <div class="row no-gutter">
                    ...
                    <div class="col-12">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span style="width:150px;height:50px" class="form-control form-control-sm input-group-text " id="inputGroup-sizing-sm">Keterangan</span>
                            </div>
                            <textarea name="keterangan" id="" style="height:50px;" class="form-control form-control-sm ubah_data_input keterangan_' . $id_packing . '" data-id_packing="' . $id_packing . '">' . $keterangan . ' </textarea>
                        </div>
                    </div>
                </div>
            </div>
...
if (isset($_POST['ubah_data_barang_kurang'])) {
    ...
    // $subtotal = ($qty * $ttl_subtotal);
    if (isset($_POST['polybag'])) {
        $sql = mysqli_fetch_assoc(mysqli_query($conn, "SELECT polybag FROM tb_packing WHERE no_id = '" . $no_id . "'"));
        $polybag = $sql['polybag'] - 1;
        $sql_update_barang_keluar = mysqli_query($conn, "
            UPDATE
                tb_packing
            SET
        ...
        $sql = mysqli_fetch_assoc(mysqli_query($conn, "SELECT pcs FROM tb_packing WHERE no_id = '" . $no_id . "'"));
        $pcs = $sql['pcs'] - 1;
        $sql_update_barang_keluar = mysqli_query($conn, "
            UPDATE
                tb_packing
