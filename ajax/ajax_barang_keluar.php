...
if (isset($_POST['cari_nama_customer_piutang'])) {
    $nama_customer = mysqli_real_escape_string($conn, $_POST['cari_nama_customer_piutang']);
...
if(isset($_POST['ubah_data_barang_tembak'])){
    ...
    $non_stock = 0;
    $sql_get_barang_keluar = mysqli_query($conn, "
        SELECT 
            non_stock
        FROM
            tb_barang_keluar
