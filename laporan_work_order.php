                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-15">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = mysqli_query($conn, "SELECT a.* FROM tb_work_order a WHERE a.id_transaksi LIKE '%WO%' GROUP BY a.id_transaksi ORDER BY id_transaksi DESC");
                                        ...
                                        while ($row = mysqli_fetch_array($sql)) {
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    if($row['efisiensi_cutting'] == ''){
                                                        echo '<td class="fs-11" style="vertical-align:top;">-</td>';
                                                    }else{
                                                        echo '<td class="fs-11" style="vertical-align:top;">' . $row['efisiensi_cutting'] . '%</td>';
                                                    }
                                                    echo '
