                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-15">
                                    ...
                                    <tbody>
                                        ...
                                        $ttlTurun = 0;
                                        $ttlBtj = 0;
                                        $sql = mysqli_query($conn, "SELECT id_bahan_kain,kode_bahan_kain,nama_kain FROM tb_bahan_kain WHERE kategori = 'KAIN JADI' ");
                                        ...
                                        while ($row = mysqli_fetch_array($sql)) {
                                            ...
                                            $qty_masuk = number_format($row_stock1['masuk']);
                                            $qty_keluar = number_format($row_pakai1['keluar']);
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    if($qty_awal <= 0){
                                                        ...
                                                        echo "<td class='fs-11 text-center' style='vertical-align:top;'>".$qty_awal."</td>";
                                                    }
                                                    if($qty_masuk <= 0){
                                                        echo "<td class='fs-11 text-center' style='vertical-align:top;'> 0 </td>";
                                                    }else{
                                                        echo "<td class='fs-11 text-center' style='vertical-align:top;'>".$qty_masuk."</td>";
                                                    }
                                                    if($qty_keluar <= 0){
                                                        echo "<td class='fs-11 text-center' style='vertical-align:top;'> 0 </td>";
                                                    }else{
                                                        echo "<td class='fs-11 text-center' style='vertical-align:top;'>" . $qty_keluar . "</td>";
                                                    }
                                                    if($qty_akhir <= 0){
                                                        echo "<td class='fs-11 text-center' style='vertical-align:top;'> 0 </td>";
                                                    }else{
                                                        echo "<td class='fs-11 text-center' style='vertical-align:top;'>".$qty_akhir."</td>";
                                                    }
