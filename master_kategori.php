...
if (isset($_POST['save'])) {
    ...
    $select_bahan = "SELECT * FROM tb_kategori WHERE id_kategori = '" . $id . "'";
    $query_bahan = mysqli_query($conn, $select_bahan);
    $jum_bahan = mysqli_num_rows($query_bahan);

    if ($jum_bahan < 1) {
        $insert = "INSERT INTO tb_kategori(
    ...
    echo "<script type='text/javascript'>alert('" . $msg . "');window.location='master_kategori.php';</script>";
}

if (isset($_POST['delete'])) {
    $valid = 1;
    $query = mysqli_query($conn, "DELETE FROM tb_kategori WHERE id_kategori ='" . mysqli_real_escape_string($conn, $_POST['id_hapus']) . "'");
    if (!$query) {
        $valid = 0;
    ...
    echo "<script type='text/javascript'>alert('" . $msg . "');window.location.href='master_kategori.php';</script>";
}
...
if (isset($_POST['import'])) {
    ...
    if (($h = fopen("modul/script/{$filename}", "r")) !== FALSE) {
        ...
        echo "<script>alert('invalid input');window.location='master_kategori.php';</script>";
        $status = "";
    }
    echo "<script>alert('" . $status . "');window.location='master_kategori.php';</script>";
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="text-transform: none;">
                            <div class="form-inline">
                                <h3 class="mr-2">Master Kategori</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-15" id="datable_1">
                                    ...
                                    <tbody>
                                        <?php
                                        $n = 1;
                                        $sql = mysqli_query($conn, "SELECT * FROM tb_kategori ORDER BY id_kategori ASC");
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Master Kategori</h5>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Kode</label>
                            <input type="text" name="kode" id="" class="form-control kode" required>
                        </div>
                        <div class="form-group">
