                                                ...
                                                echo '
                                                            <tr >
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <input type="number" name="qty_sp_' . $no_id . '" style="display:inline;width:65px" class="form-control form-control-sm ubah_data_qty_sp qty_sp_' . $no_id . '" data-no_id="' . $no_id . '" value="' . $qty_sp . '" ' . $readonly . ' >
