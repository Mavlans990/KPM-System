                            ...
                            <div class="col-12">
                                <div class="table-responsive daftar_bahan">
                                    ...
                                    while ($row = mysqli_fetch_assoc($select_barang_masuk)) {
                                        ...
                                        // </td>
                                        $ksl_qty_kain_baku += $bruto;
                                        $ksl_qty_netto_baku += $netto;
                                    }
                                    // <td class="text-center" style="color:red"></td>
                                    echo '
                                                <tr >
                                                    <td class="text-center" style="color:red">Total</td>
                                                    <td class="text-center" style="color:red">' . $ksl_qty_kain_baku . '</td>
                                                    <td class="text-center" style="color:red">' . $ksl_qty_netto_baku . '</td>
                                            ...
                                            <div class="row no-gutter">
                                                <div class="col-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        $total_bom = $ksl_bom;
                                                        // echo $total_bom.'<br>';
                                                        $bahan_pakai = $ksl_qty_kain_baku;
                                                        // echo $bahan_pakai.'<br>';

                                                        $efisiensia = 0;
                                                        $efisiensi_bom = 0;
                                                        if($total_bom != 0 && $bahan_pakai != 0){
                                                            $efisiensia = $total_bom - $bahan_pakai;
                                                            $efisiensi_bom = $efisiensia / $bahan_pakai;
                                                            // $efisiensi_bom = $total_bom / $bahan_pakai;
                                                        }
                                                        // echo $efisiensi_bom.'<br>';

                                                        $persen_efisien = $efisiensi_bom * 100;
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="efisiensi_cutting" id="" class="form-control form-control-sm efisiensi" value="<?= round($persen_efisien,2); ?>%" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
