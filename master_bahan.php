...
if (isset($_POST['save'])) {
    ...
    $select_bahan = "SELECT * FROM tb_bahan WHERE id_bahan = '" . $id . "'";
    ...
    echo "<script type='text/javascript'>alert('" . $msg . "');window.location='master_bahan.php';</script>";
}

if (isset($_POST['delete'])) {
    $valid = 1;
    $query = mysqli_query($conn, "DELETE FROM tb_bahan WHERE id_bahan='" . mysqli_real_escape_string($conn, $_POST['id_hapus']) . "'");
    if (!$query) {
        $valid = 0;
    ...
    echo "<script type='text/javascript'>alert('" . $msg . "');window.location.href='master_bahan.php';</script>";
}
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="text-transform: none;">
                            <div class="form-inline">
                                <h3 class="mr-2">Master Barang</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-15" id="datable_1">
                                    ...
                                    <tbody>
                                        <?php
                                        $n = 1;
                                        $sql = mysqli_query($conn, "SELECT * FROM tb_bahan ORDER BY id_bahan ASC");
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="id_bahan" id="" class="form-control filled-input id_bahan" value="<?= $id_bahan; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label>Nama Barang</label>
                            <input type="text" name="nama_bahan" id="" class="form-control nama_bahan" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label>UOM</label>
                            <input type="text" name="uom" id="" class="form-control form-control-sm uom">
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".add_new", function() {
        $(".id_bahan").val("<?php echo $id_bahan; ?>");
        $(".nama_bahan").val("");
        $(".uom").val("");
    });
