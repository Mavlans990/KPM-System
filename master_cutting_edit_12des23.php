            ...
            if ($query_update) {
                ...
                while ($row_sisa = mysqli_fetch_assoc($select_sisa)) {
                    ...
                    if($sisa_bahan > 0){
                        ...
                        $jum_row_sisa= mysqli_num_rows($select_update_sisa);
                        if($jum_row_sisa > 0){
                            $sql_update_sisa = "UPDATE tb_barang_masuk SET bruto = '".$sisa_bahan."',netto = '".$sisa_bahan."' WHERE barcode = '".$barcode."' AND id_bahan_kain = '".$id_bahan_kain."' AND keterangan LIKE '%Bahan Sisa%'";
                            // echo "<br>$sql_update_sisa<br>";
                            mysqli_query($conn,$sql_update_sisa);
                        }else{
