                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-sm w-100 display tb_jps_re_ins tb_jps_ins mt-15">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_get_barang_keluar = mysqli_query($conn, "SELECT a.* FROM tb_packing a WHERE a.id_transaksi LIKE '%WO%' " . $where_tgl . " AND id_invoice != 'temp' GROUP BY a.id_packing ORDER BY a.id_invoice ASC LIMIT 50");
